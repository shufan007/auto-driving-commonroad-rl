...
from stable_baselines3.common.policies import FeedForwardPolicy as BasePolicy
from stable_baselines3.common.policies import register_policy
from stable_baselines3.sac.policies import FeedForwardPolicy as SACPolicy
from stable_baselines3.bench import Monitor
from stable_baselines3 import logger
from stable_baselines3 import PPO2, A2C, ACER, ACKTR, HER, SAC, TD3, GAIL

# DDPG and TRPO require MPI to be installed
if mpi4py is None:
    DDPG, TRPO = None, None
else:
    from stable_baselines3 import DDPG, TRPO
