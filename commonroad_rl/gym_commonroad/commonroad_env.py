...
class CommonroadEnv(gym.Env):
    ...
    def reset(self, benchmark_id=None, scenario: Scenario = None, planning_problem: PlanningProblem = None,
              seed: Optional[int] = None, options: Optional[dict] = None) -> np.ndarray:
        """
