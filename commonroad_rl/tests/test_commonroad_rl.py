...
from commonroad_rl.train_model import run_stable_baselines3, run_stable_baselines3_argsparser
...
def run_overfit(test_batch, goal_relaxation, num_of_steps, env_id):
    ...
    args = run_stable_baselines3_argsparser().parse_args(args_str.split(sep=" "))
    run_stable_baselines3(args)  # , save_path=os.path.join(output_path, "model"))
